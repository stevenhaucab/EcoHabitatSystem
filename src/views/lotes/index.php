    ...
    <div class="row">
        <div class="container">
            <div class="d-flex justify-content-between mb-3">
                <h3><?= $title ?></h3>
                <a href="/nuevo-lote" class="btn btn-primary">Agregar Nueva Lote</a>
            </div>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <?php foreach ($lotes as $lote): ?>
                                <tr>
                                    <td><?= strtoupper($lote['lote_name']); ?></td>
                                    <td><?= strtoupper($lote['desarrollo_name']); ?></td>
                                    <td>
                                        <a href="/editar-lote/<?= $lote['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
